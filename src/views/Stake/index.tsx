...
function Stake() {
    ...
    const onChangeStake = async (action: string) => {
        const isWrongNetwork = await checkWrongNetwork();
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <div className="stake-index">
                                            ...
                                            <p className="single-stake-subtitle-value">
                                                {currentIndex ? (
                                                    <>{trim(Number(currentIndex), 2)} META</>
                                                ) : (
                                                    <Skeleton width="150px" />
                                                )}
                                            </p>
                                            ...
                                            <TabPanel value={view} index={0} className="stake-tab-panel">
                                                {address && hasAllowance("time") ? (
                                                    ...
                                                    <div
                                                        className="stake-tab-panel-btn"
                                                        onClick={() => {
                                                            if (isPendingTxn(pendingTransactions, "approve_staking"))
                                                                return;
                                                            onSeekApproval("time");
                                                        }}
                                                    >
                                            ...
                                            <TabPanel value={view} index={1} className="stake-tab-panel">
                                                {address && hasAllowance("memo") ? (
                                                    ...
                                                    <div
                                                        className="stake-tab-panel-btn"
                                                        onClick={() => {
                                                            if (isPendingTxn(pendingTransactions, "approve_unstaking"))
                                                                return;
                                                            onSeekApproval("memo");
                                                        }}
                                                    >
                                            ...
                                            {address &&
                                                ((!hasAllowance("time") && view === 0) ||
                                                    ...
                                                    <p className="text-desc">
                                                        ...
                                                        staking/unstaking only requires you to perform the "Stake" or
                                                        "Unstake" transaction.
                                                    </p>
                                                )}
                                        </div>
