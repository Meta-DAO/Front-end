                        ...
                        {({ TransitionProps }) => (
                            <Fade {...TransitionProps} timeout={200}>
                                <div className="tooltip">
                                    <Link className="tooltip-item" href="https://github.com/Meta-DAO/Front-end" target="_blank">
                                        <SvgIcon color="primary" component={GitHub} />
                                        <p>GitHub</p>
                                    </Link>
                                    <Link className="tooltip-item" href="https://twitter.com/MetaDAOhq" target="_blank">
                                    ...
                                    <Link className="tooltip-item" href="https://discord.gg/TdprhpCbDh" target="_blank">
