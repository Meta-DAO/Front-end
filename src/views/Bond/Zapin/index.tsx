                    ...
                    <div className="zapin-body">
                        ...
                        <div className="zapin-body-params">
                            ...
                            <div className="data-row">
                                ...
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `~ ${trim(bond.bondQuote, 4)} META`}</p>
                            </div>
                            <div className="data-row">
                                <p className="data-row-name">Max You Can Buy</p>
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4)} META`}</p>
                            </div>
                            <div className="data-row">
                            ...
                            <div className="data-row">
                                ...
                                <p className="data-row-value">0.01 META</p>
                            </div>
